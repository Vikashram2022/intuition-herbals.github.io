...
function mixxcazt_megamenu_add_back_button_inspector() {
	...
	?>
        <script type="text/template" id="tmpl-elementor-panel-footer-content">
				...
				<div class="elementor-panel-footer-sub-menu-wrapper">
					<div class="elementor-panel-footer-sub-menu">
						<div class="elementor-panel-footer-sub-menu-item" data-device-mode="desktop">
							...
							<span class="elementor-title"><?php echo esc_html__( 'Desktop', 'mixxcazt' ); ?></span>
							<span class="elementor-description"><?php echo esc_html__( 'Default Preview', 'mixxcazt' ); ?></span>
						</div>
						<div class="elementor-panel-footer-sub-menu-item" data-device-mode="tablet">
							...
							<span class="elementor-title"><?php echo esc_html__( 'Tablet', 'mixxcazt' ); ?></span>
							<?php $breakpoints = Elementor\Core\Responsive\Responsive::get_breakpoints(); ?>
							<span class="elementor-description"><?php echo sprintf( esc_html__( 'Preview for %s', 'mixxcazt' ), $breakpoints['md'] . 'px' ); ?></span>
						</div>
						<div class="elementor-panel-footer-sub-menu-item" data-device-mode="mobile">
							...
							<span class="elementor-title"><?php echo esc_html__( 'Mobile', 'mixxcazt' ); ?></span>
							<span class="elementor-description"><?php echo esc_html__( 'Preview for 360px', 'mixxcazt' ); ?></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="elementor-panel-saver-button-preview" class="elementor-panel-footer-tool tooltip-target" data-tooltip="<?php esc_attr_e( 'Preview Changes', 'mixxcazt' ); ?>">
				<span id="elementor-panel-saver-button-preview-label">
					<i class="fa fa-eye" aria-hidden="true"></i>
					<span class="elementor-screen-only"><?php echo esc_html__( 'Preview Changes', 'mixxcazt' ); ?></span>
				</span>
			</div>
			...
			<div id="elementor-panel-saver-save-options" class="elementor-panel-footer-tool" >
				<button id="elementor-panel-saver-button-save-options" class="elementor-button elementor-button-success tooltip-target elementor-saver-disabled" data-tooltip="<?php esc_attr_e( 'Save Options', 'mixxcazt' ); ?>">
				...
				<div class="elementor-panel-footer-sub-menu-wrapper">
					...
					<div class="elementor-panel-footer-sub-menu">
						<div id="elementor-panel-saver-menu-save-draft" class="elementor-panel-footer-sub-menu-item elementor-saver-disabled">
							...
							<span class="elementor-title"><?php echo esc_html__( 'Save Draft', 'mixxcazt' ); ?></span>
						</div>
						<div id="elementor-panel-saver-menu-save-template" class="elementor-panel-footer-sub-menu-item">
							...
							<span class="elementor-title"><?php echo esc_html__( 'Save as Template', 'mixxcazt' ); ?></span>
						</div>
					</div>
				</div>
			</div>
					...
					<% } %>
						<div class="mixxcazt-modal-content">
							...
							<div class="form-group icon-custom toggle-select-setting elementor-hidden">
								...
								<input type="text" name="mixxcazt-menu-item[icon-custom]" class="input" id="icon-custom"/>
							</div>
