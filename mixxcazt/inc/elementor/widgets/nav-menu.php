...
class Mixxcazt_Elementor_Nav_Menu extends Elementor\Widget_Base{

    protected $nav_menu_index = 1;

    public function get_name()
    {
        return 'mixxcazt-nav-menu';
    }

    public function get_title()
    {
        return esc_html__('Mixxcazt Nav Menu', 'mixxcazt');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'layout-1',
                'prefix_class' => 'mixxcazt-nav-menu-',
            ]
        );
        $this->add_control(
            'show_full_menu',
            [
                'label' => esc_html__( 'Full Width', 'mixxcazt' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'layout_style' => 'layout-2',
                ],
                'prefix_class' => 'mixxcazt-nav-menu-show-full-menu-',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography Menu', 'mixxcazt'),
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Typography Sub Menu', 'mixxcazt'),
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label'     => esc_html__( 'Color Menu', 'mixxcazt' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Color Sub Menu', 'mixxcazt' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label'     => esc_html__( 'Background Dropdown', 'mixxcazt' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_divider',
            [
                'label'     => esc_html__( 'Divider Border', 'mixxcazt' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'condition' => [
                    'show_divider' => 'yes',
        ...
        $this->add_control(
            'color_line',
            [
                'label'     => esc_html__( 'Divider Line', 'mixxcazt' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'condition' => [
                    'show_line' => 'yes',
                ...
                'selectors' => [
                    '{{WRAPPER}}.line-hover-nav-menu-active-yes .main-navigation ul.menu > li > a:before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Background Item', 'mixxcazt' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'show_divider',
            [
                'label' => esc_html__( 'Show Divider', 'mixxcazt' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'show_line',
            [
                'label' => esc_html__( 'Line Hover', 'mixxcazt' ),
                'type' => Controls_Manager::SWITCHER,
                'prefix_class' => 'line-hover-nav-menu-active-',
            ]
        );
    ...
    protected function render()
    {
        ...
        <div <?php echo mixxcazt_elementor_get_render_attribute_string('wrapper', $this);?>>
            <nav class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'mixxcazt'); ?>">
...
$widgets_manager->register_widget_type(new Mixxcazt_Elementor_Nav_Menu());
