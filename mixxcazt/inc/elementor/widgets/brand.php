 ...
 * @since 1.0.0
 */
class Mixxcazt_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'mixxcazt');
    }
    ...
    public function get_script_depends() {
        return ['mixxcazt-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'mixxcazt'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'mixxcazt'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'mixxcazt'),
                'placeholder' => esc_html__('Brand Name', 'mixxcazt'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'options' => [
                    'image' => esc_html__('Image', 'mixxcazt'),
                    'icon'  => esc_html__('Icon & SVG', 'mixxcazt'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'prefix_class'	=> 'mixxcazt-brand-border-'
            ]
        );
        ...
        $this->start_controls_section(
            'style_brand_icon',
            [
                'label' => esc_html__('Icon & SVG', 'mixxcazt'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'icon_color_hover',
            [
                'label'     => esc_html__('Primary Color', 'mixxcazt'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                        ...
                        <div <?php echo mixxcazt_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . mixxcazt_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
...
$widgets_manager->register_widget_type(new Mixxcazt_Elementor_Brand());
