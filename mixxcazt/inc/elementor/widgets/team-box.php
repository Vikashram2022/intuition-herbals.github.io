...
class Mixxcazt_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'mixxcazt');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_team',
            [
                'label' => esc_html__('Team', 'mixxcazt'),
            ]
        );
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'mixxcazt'),
        ...
        $this->add_control(
            'description',
            [
                'label'   => esc_html__('Description', 'mixxcazt'),
        ...
        $this->add_control(
            'facebook',
            [
                'label'       => esc_html__('Facebook', 'mixxcazt'),
                'placeholder' => esc_html__('https://www.facebook.com/opalwordpress', 'mixxcazt'),
        ...
        $this->add_control(
            'twitter',
            [
                'label'       => esc_html__('Twitter', 'mixxcazt'),
                'placeholder' => esc_html__('https://twitter.com/opalwordpress', 'mixxcazt'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => esc_html__('Youtube', 'mixxcazt'),
                'placeholder' => esc_html__('https://www.youtube.com/user/WPOpalTheme', 'mixxcazt'),
        ...
        $this->add_control(
            'google',
            [
                'label'       => esc_html__('Google', 'mixxcazt'),
                'placeholder' => esc_html__('https://plus.google.com/u/0/+WPOpal', 'mixxcazt'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'mixxcazt'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                        ...
                        <?php if (!empty($settings[$key])) : ?>
                            <li class="social">
                                <a href="<?php echo esc_url($settings[$key]) ?>">
                                    <i class="mixxcazt-icon-<?php echo esc_attr($social); ?>"></i>
                                </a>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
...
$widgets_manager->register_widget_type(new Mixxcazt_Elementor_Team_Box());
