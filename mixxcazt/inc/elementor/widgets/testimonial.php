...
class Mixxcazt_Elementor_Testimonials extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Mixxcazt Testimonials', 'mixxcazt');
    }
    ...
    public function get_script_depends() {
        return ['mixxcazt-elementor-testimonial', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => esc_html__('Testimonials', 'mixxcazt'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_rating',
            [
                'label'   => esc_html__('Rating', 'mixxcazt'),
                'default' => 5,
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    0 => esc_html__('Hidden', 'mixxcazt'),
                    1 => esc_html__('Very poor', 'mixxcazt'),
                    2 => esc_html__('Not that bad', 'mixxcazt'),
                    3 => esc_html__('Average', 'mixxcazt'),
                    4 => esc_html__('Good', 'mixxcazt'),
                    5 => esc_html__('Perfect', 'mixxcazt'),
                ]
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            'testimonial_name',
            [
                'label'   => esc_html__('Name', 'mixxcazt'),
                'default' => 'John Doe',
                'type'    => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            'testimonials',
            [
                'label'       => esc_html__('Items', 'mixxcazt'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-testimonial-rating i' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-testimonial-rating' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
            ...
            <div <?php echo mixxcazt_elementor_get_render_attribute_string('wrapper', $this); // WPCS: XSS ok. ?>>
                <div <?php echo mixxcazt_elementor_get_render_attribute_string('row', $this); // WPCS: XSS ok. ?>>
                    <?php foreach ($settings['testimonials'] as $testimonial): ?>
                        <div <?php echo mixxcazt_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="inner">
                                <?php if ($testimonial['testimonial_rating'] && $testimonial['testimonial_rating'] > 0) {
                                    ...
                                    for ($i = 1; $i <= 5; $i++) {
                                        if ($i <= $testimonial['testimonial_rating']) {
                                            echo '<i class="mixxcazt-icon- mixxcazt-icon-star-fill active" aria-hidden="true"></i>';
                                        }
                                    }
                                    echo '</div>';
                                }
                                ...
                                <div class="testimonial-content">
                                    ...
                                    <div class="testimonial-caption">
                                        ...
                                        <?php if ($settings['testimonial_layout'] != 'style-4'): $this->render_image($settings, $testimonial); endif; ?>

                                        <div <?php echo mixxcazt_elementor_get_render_attribute_string('details', $this); // WPCS: XSS ok. ?>>
                                            <?php
                ...
                <?php if ($settings['enable_carousel'] == 'yes' && $settings['testimonial_layout'] == 'style-4') {
                    ?>
...
$widgets_manager->register_widget_type(new Mixxcazt_Elementor_Testimonials());
